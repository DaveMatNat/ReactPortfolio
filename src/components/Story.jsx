    ...
    return (
        ...
        >
            <div className='max-w-[1000px] mx-auto flex flex-col gap-[1.25rem]'>
                ...
                <div className="border-1 rounded-xl p-10 bg-slate-950">
                    <h2 className="text-4xl sm:text-6xl py-5 mx-auto text-center mb-5 text-slate-400">My lore!</h2>
                    ...
                    <p className='text-base sm:text-xl'>
                        ...
                        instead of wood and stone. And honestly, I’m still just getting started.
                    </p>
                </div>
            </div>
        </section>
