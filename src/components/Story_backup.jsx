                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="pt-4 border-t border-slate-800">
                                     ...
                                     <div className="space-y-2 font-mono text-xs">
                                        ...
                                        <div className="flex items-start gap-2 text-emerald-400 bg-emerald-900/10 p-1.5 rounded border border-emerald-900/30">
                                            <span className="text-base">🚀</span>
                                            <div>
                                                <p className="font-bold">Accelerate DC Pitch</p>
                                                <p className="text-[10px] opacity-75">1st Runner-Up ($2k)</p>
                                            </div>
                                        </div>
                                     </div>
                                </div>
                                ...
                                {/* Active Buffs */}
                                <div className="pt-4 border-t border-slate-800">
                                     <h4 className="text-xs uppercase tracking-wider text-slate-500 mb-3 font-bold">Active Buffs</h4>
                                     <div className="grid grid-cols-2 gap-2 text-[10px] font-mono">
                                         <div className="bg-slate-800/50 p-2 rounded border border-slate-700/50 flex flex-col gap-1 hover:bg-slate-800 transition-colors">
                                             <div className="flex items-center gap-2 text-emerald-400">
                                                 <span>⚡</span>
                                                 <span className="font-bold">Quick Learner</span>
                                             </div>
                                             <p className="text-slate-500">+20% EXP Gain</p>
                                         </div>
                                         <div className="bg-slate-800/50 p-2 rounded border border-slate-700/50 flex flex-col gap-1 hover:bg-slate-800 transition-colors">
                                             ...
                                             <p className="text-slate-500">Code Speed x2 (PM)</p>
                                         </div>
                                         <div className="bg-slate-800/50 p-2 rounded border border-slate-700/50 flex flex-col gap-1 hover:bg-slate-800 transition-colors">
                                             <div className="flex items-center gap-2 text-purple-400">
                                                 <span>🌐</span>
                                                 <span className="font-bold">Bi-Lingual</span>
                                             </div>
                                             <p className="text-slate-500">Thai/English</p>
                                         </div>
                                         <div className="bg-slate-800/50 p-2 rounded border border-slate-700/50 flex flex-col gap-1 hover:bg-slate-800 transition-colors">
                                             <div className="flex items-center gap-2 text-amber-400">
                                                 <span>🤝</span>
                                                 <span className="font-bold">Socializer</span>
                                             </div>
                                             <p className="text-slate-500">Charisma +10</p>
                                         </div>
                                     </div>
                                </div>
                                ...
                                <div className="pt-4 border-t border-slate-800">
                                     <h4 className="text-xs uppercase tracking-wider text-slate-500 mb-3 font-bold">Current Quest</h4>
                                     <div className="space-y-3 font-mono text-xs">
                                        <div className="bg-slate-800/30 p-3 rounded-md border border-slate-700/30">
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="text-white font-bold">Developing "ReactPortfolio"</span>
                                                <span className="text-xs text-yellow-500 animate-pulse">In Progress</span>
                                            </div>
                                            <p className="text-[10px] text-slate-400 mb-3">
                                                Objective: Build the ultimate interactive personal site to showcase 
                                                lore, skills, and projects.
                                            </p>
                                            <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
                                                <div className="bg-yellow-500 h-full w-[88%] relative">
                                                    <div className="absolute right-0 top-0 bottom-0 w-2 bg-white/20 animate-ping"></div>
                                                </div>
                                            </div>
                                            <div className="flex justify-between text-[10px] text-slate-500 mt-1">
                                                <span>Tasks: 9/10</span>
                    ...
                    <div className="md:col-span-7 space-y-12">
                        ...
                        <div className="relative pl-8 border-l-2 border-slate-800 hover:border-slate-600 transition-colors duration-300">
                             ...
                             <h4 className="text-xl font-bold text-white mb-2">The Pre-Game Lobby</h4>
                             <p className="text-slate-400 leading-relaxed text-lg">
                        ...
                        <div className="relative pl-8 border-l-2 border-slate-800 hover:border-slate-600 transition-colors duration-300">
                             ...
                             <h4 className="text-xl font-bold text-white mb-2">Joining the Server</h4>
                             <p className="text-slate-400 leading-relaxed text-lg">
                        ...
                        <div className="relative pl-8 border-l-2 border-slate-800 hover:border-slate-600 transition-colors duration-300">
                             ...
                             <h4 className="text-xl font-bold text-white mb-2">The Grind</h4>
                             <p className="text-slate-400 leading-relaxed text-lg">
                        ...
                        <div className="relative pl-8 border-l-2 border-slate-800 hover:border-slate-600 transition-colors duration-300">
                             ...
                             <h4 className="text-xl font-bold text-white mb-2">PvP & Tournaments</h4>
                             <p className="text-slate-400 leading-relaxed text-lg">
