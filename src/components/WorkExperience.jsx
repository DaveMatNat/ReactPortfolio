    ...
    return (
        ...
        >
            <div className="max-w-[1000px] mx-auto flex flex-col gap-[1rem]">
                ...
                {experiences
                    .sort((a, b) => a.order - b.order) // sorts by the order field
                    .map((exp) => (
                        <div key={exp.order} className="flex flex-col gap-2">
                            ...
                            <ul className="list-disc ml-6 text-base sm:text-lg leading-relaxed ">
